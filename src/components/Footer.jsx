    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            <CountryAwareLink to="/" onClick={handleLinkClick} className="inline-block">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-xl">D</span>
                </div>
                <span className="text-2xl font-bold">DevWears</span>
              </div>
            </CountryAwareLink>
            <p className="text-gray-300 mb-6 max-w-md">
              Discover the latest trends in fashion with DevWears. We bring you premium quality clothing 
              that combines style, comfort, and affordability.
            </p>
